...
waldayu.transducers["tsugaru japanese dialect_compare"] = (function() {
    var correspondences = {'k': 'k', 'g': 'k', 'ŋ': 'g'};
    var keys = ['k', 'g', 'ŋ'];
    ...
    "L1": {
        "name": "Tsugaru Japanese dialect",
        "underlying": "",
        "compare": "tsugaru japanese dialect_compare",
